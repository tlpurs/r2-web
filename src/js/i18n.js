...
const I18N = {
  zh: {
    ...
    r2UsageSubtitle: '当月 A/B 类操作次数与免费额度对比',
    r2UsageQuery: '查询本月用量',
    r2UsageClose: '关闭',
    r2UsageRefresh: '重新查询',
  ...
  zh_TW: {
    ...
    r2Usage: '本月 R2 用量',
    r2UsageTitle: '本月 R2 用量',
    r2UsageSubtitle: '當月 A/B 類操作次數與免費額度對比',
    r2UsageQuery: '查詢本月用量',
    r2UsageClose: '關閉',
    r2UsageRefresh: '重新查詢',
  ...
  en: {
    ...
    r2UsageSubtitle: 'This month\'s Class A/B operations vs free quota',
  ...
  ja: {
    ...
    r2UsageSubtitle: '当月の A/B 類操作回数と無料枠の比較',
    r2UsageQuery: '使用量を確認',
    r2UsageClose: '閉じる',
    r2UsageRefresh: '再取得',
