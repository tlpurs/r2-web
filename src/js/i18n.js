...
const I18N = {
  zh: {
    ...
    tooltipAccessKeyId: 'R2 API 访问密钥 ID，在 R2 控制台右下角可创建和管理',
    tooltipSecretAccessKey: 'R2 API 秘密访问密钥，在 R2 控制台右下角可创建和管理，仅本地不上传到任何服务器',
    tooltipBucket: 'R2 存储桶名称，所有文件操作将在此桶下进行',
    tooltipCustomDomain: '自定义域名（可选），配置后可复制公开访问链接',
    ...
    tooltipLanguage: '切换界面显示语言，支持简体中文、繁体公文、英语和日语',
    ...
    // R2 usage
    cfApiToken: 'Cloudflare API Token（用量统计）',
    tooltipCfApiToken: '用于查询 R2 当月 A/B 类操作次数，需要账户分析读取权限，仅保存在本地',
    r2Usage: '本月 R2 用量',
    r2UsageTitle: '本月 R2 用量',
    r2UsageSubtitle: '当月 A/B 类操作次数、存储空间与免费额度对比',
    r2UsageQuery: '查询本月用量',
    r2UsageClose: '关闭',
    r2UsageRefresh: '重新查询',
    r2UsageLoading: '正在查询 Cloudflare 用量…',
    r2UsageError: '查询失败：{msg}',
    r2UsageNoToken: '请在 R2 设置中填写 Cloudflare API Token',
    r2UsageClassA: 'A 类操作（写/列/删）',
    r2UsageClassAHint: '写、列、删除等操作，免费额度 100 万次/月',
    r2UsageClassB: 'B 类操作（读/上传分片）',
    r2UsageClassBHint: '读、上传分片等操作，免费额度 1000 万次/月',
    r2UsageQuota: '{used} / {free} 次',
    r2UsageStorage: '存储空间',
    r2UsageStorageHint: '对象占用的总存储量，免费额度 10 GB',
    r2UsageStorageQuota: '{used} / {free}',
    r2UsageDetail: '数据来源：Cloudflare GraphQL Analytics API，统计可能有数小时延迟。',
    // Batch operations
    selectFile: '选择文件',
    batchMode: '批量操作',
    exitBatchMode: '退出批量',
    ...
    editContentType: '修改类型',
    editContentTypeTitle: '修改 Content-Type',
    editContentTypeLabel: 'Content-Type',
    editContentTypeInvalid: '格式不正确，示例：image/jpeg',
    editingContentType: '正在修改 "{name}" 的 Content-Type...',
    editContentTypeSuccess: '已将 "{name}" 的 Content-Type 修改为 {type}',
  },
  zh_TW: {
    appTitle: 'R2 Web',
    connectTitle: '連接到 R2',
    ...
    aboutUpdatedLabel: '更新日期',
    // R2 usage
    cfApiToken: 'Cloudflare API Token（用量統計）',
    tooltipCfApiToken: '用於查詢 R2 當月 A/B 類操作次數，需要帳戶分析讀取權限，僅儲存在本地',
    r2Usage: '本月 R2 用量',
    r2UsageTitle: '本月 R2 用量',
    r2UsageSubtitle: '當月 A/B 類操作次數、儲存空間與免費額度對比',
    r2UsageQuery: '查詢本月用量',
    r2UsageClose: '關閉',
    r2UsageRefresh: '重新查詢',
    r2UsageLoading: '正在查詢 Cloudflare 用量…',
    r2UsageError: '查詢失敗：{msg}',
    r2UsageNoToken: '請在 R2 設定中填寫 Cloudflare API Token',
    r2UsageClassA: 'A 類操作（寫/列/刪）',
    r2UsageClassAHint: '寫、列、刪除等操作，免費額度 100 萬次/月',
    r2UsageClassB: 'B 類操作（讀/上傳分片）',
    r2UsageClassBHint: '讀、上傳分片等操作，免費額度 1000 萬次/月',
    r2UsageQuota: '{used} / {free} 次',
    r2UsageStorage: '儲存空間',
    r2UsageStorageHint: '物件佔用的總儲存量，免費額度 10 GB',
    r2UsageStorageQuota: '{used} / {free}',
    r2UsageDetail: '資料來源：Cloudflare GraphQL Analytics API，統計可能有數小時延遲。',
    // Batch operations
    selectFile: '選擇檔案',
    batchMode: '批量操作',
    exitBatchMode: '退出批量',
    ...
    editContentType: '修改類型',
    editContentTypeTitle: '修改 Content-Type',
    editContentTypeLabel: 'Content-Type',
    editContentTypeInvalid: '格式不正確，範例：image/jpeg',
    editingContentType: '正在修改「{name}」的 Content-Type…',
    editContentTypeSuccess: '已將「{name}」的 Content-Type 修改為 {type}',
  },
  en: {
    appTitle: 'R2 Web',
    ...
    // R2 usage
    cfApiToken: 'Cloudflare API Token (Usage)',
    tooltipCfApiToken: 'Used to query this month\'s R2 Class A/B operations. Requires account analytics read permission. Stored locally only.',
    r2Usage: 'Monthly R2 Usage',
    r2UsageTitle: 'Monthly R2 Usage',
    r2UsageSubtitle: 'This month\'s Class A/B operations, storage vs free quota',
    r2UsageQuery: 'Query Usage',
    r2UsageClose: 'Close',
    r2UsageRefresh: 'Refresh',
    r2UsageLoading: 'Querying Cloudflare usage…',
    r2UsageError: 'Query failed: {msg}',
    r2UsageNoToken: 'Please enter your Cloudflare API Token in R2 settings',
    r2UsageClassA: 'Class A (Write/List/Delete)',
    r2UsageClassAHint: 'Write, list, delete operations. Free quota: 1M/month',
    r2UsageClassB: 'Class B (Read/Upload Parts)',
    r2UsageClassBHint: 'Read, upload-part operations. Free quota: 10M/month',
    r2UsageQuota: '{used} / {free} ops',
    r2UsageStorage: 'Storage',
    r2UsageStorageHint: 'Total object storage used. Free quota: 10 GB',
    r2UsageStorageQuota: '{used} / {free}',
    r2UsageDetail: 'Data from Cloudflare GraphQL Analytics API; may have hours of delay.',
    // Batch operations
    ...
    editContentType: 'Edit Type',
    editContentTypeTitle: 'Edit Content-Type',
    editContentTypeLabel: 'Content-Type',
    editContentTypeInvalid: 'Invalid format, e.g. image/jpeg',
    editingContentType: 'Updating Content-Type for "{name}"...',
    editContentTypeSuccess: 'Content-Type of "{name}" updated to {type}',
  },
  ja: {
    appTitle: 'R2 Web',
    connectTitle: 'R2 に接続',
    ...
    // R2 usage
    cfApiToken: 'Cloudflare API Token（使用量統計）',
    tooltipCfApiToken: '当月の R2 A/B 類操作回数を問い合わせるために使用。アカウント分析読み取り権限が必要。ローカルにのみ保存されます。',
    r2Usage: '今月の R2 使用量',
    r2UsageTitle: '今月の R2 使用量',
    r2UsageSubtitle: '当月の A/B 類操作回数、ストレージ容量と無料枠の比較',
    r2UsageQuery: '使用量を確認',
    r2UsageClose: '閉じる',
    r2UsageRefresh: '再取得',
    r2UsageLoading: 'Cloudflare 使用量を確認中…',
    r2UsageError: '取得に失敗しました：{msg}',
    r2UsageNoToken: 'R2 設定で Cloudflare API Token を入力してください',
    r2UsageClassA: 'A 類操作（書き込み/一覧/削除）',
    r2UsageClassAHint: '書き込み、一覧、削除など。無料枠 100 万回/月',
    r2UsageClassB: 'B 類操作（読み込み/パートアップロード）',
    r2UsageClassBHint: '読み込み、パートアップロードなど。無料枠 1000 万回/月',
    r2UsageQuota: '{used} / {free} 回',
    r2UsageStorage: 'ストレージ容量',
    r2UsageStorageHint: 'オブジェクトの総ストレージ使用量。無料枠 10 GB',
    r2UsageStorageQuota: '{used} / {free}',
    r2UsageDetail: 'データ元：Cloudflare GraphQL Analytics API。数時間の遅延がある場合があります。',
    // Batch operations
    selectFile: 'ファイルを選択',
    batchMode: '一括操作',
    exitBatchMode: '一括を終了',
    ...
    editContentType: 'タイプ編集',
    editContentTypeTitle: 'Content-Type を編集',
    editContentTypeLabel: 'Content-Type',
    editContentTypeInvalid: '形式が正しくありません（例: image/jpeg）',
    editingContentType: '"{name}" の Content-Type を更新しています...',
    editContentTypeSuccess: '"{name}" の Content-Type を {type} に更新しました',
  },
}
